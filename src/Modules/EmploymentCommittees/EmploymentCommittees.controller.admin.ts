...
export const AdminEmploymentCommitteesController = {
    ...
    index: async (req: Request, res: Response, next: NextFunction) => {
        ...
        let query = EmploymentCommittees.query()
        return await UtilDatabase
            .finder(EmploymentCommittees, req.query, query)
    ...
    store: async (req: Request, res: Response, next: NextFunction) => {
        ...
        const trx = await EmploymentCommittees.startTransaction()
        data.status = true
         if (file && file[0]!=null   ) {
            //get 
    ...
    update: async (req: Request, res: Response, next: NextFunction) => {
        ...
        await EmploymentCommittees
            ...
            // Delete file
            if (img) {
                const img_path = path.resolve(UPLOADS_PATH, 'EmploymentCommitteess', img.filename)
